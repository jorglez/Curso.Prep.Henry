...
function cuentoElementos(arreglo){
  ...
  //Escribe tu código aquí
  let mayores = arreglo.filter(num => num > 18);
...
function mesesDelAño(array) {
  ...
  // Tu código:
  let filtrado = array.filter(mes => mes=="Marzo"|| mes=="Noviembre" || mes == "Enero")
  if (!filtrado.find(mes=> mes=="Enero") || !filtrado.find(mes=> mes=="Marzo") || !filtrado.find(mes=> mes=="Noviembre")) {
...
function mayorACien(array) {
  ...
  // Tu código:
  let nuevo = array.filter(num => num >100)
  return nuevo
}
